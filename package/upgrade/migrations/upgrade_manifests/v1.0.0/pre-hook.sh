...
plan_name=${CLOUDWEAV_UPGRADE_NAME}-prepare-again
plan_version=${CLOUDWEAV_UPGRADE_NAME}
...
spec:
  ...
  upgrade:
    ...
    - name: CLOUDWEAV_UPGRADE_NAME
      value: ${CLOUDWEAV_UPGRADE_NAME}
    image: panmeta/cloudweav-upgrade:${REPO_CLOUDWEAV_VERSION}
