...
import (
	...
	networkv1beta1 "github.com/cloudweav/cloudweav-network-controller/pkg/apis/network.cloudweavhci.io/v1beta1"
	"github.com/cloudweav/cloudweav/pkg/apis/cloudweavhci.io/v1beta1"
)

func AggregatedWebServices() []*restful.WebService {
	cloudweavv1beta1API := NewGroupVersionWebService(v1beta1.SchemeGroupVersion)
	NewGenericResource(cloudweavv1beta1API, "virtualmachinebackups", &v1beta1.VirtualMachineBackup{}, "VirtualMachineBackup", &v1beta1.VirtualMachineBackupList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "virtualmachinerestores", &v1beta1.VirtualMachineRestore{}, "VirtualMachineRestore", &v1beta1.VirtualMachineRestoreList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "virtualmachineimages", &v1beta1.VirtualMachineImage{}, "VirtualMachineImage", &v1beta1.VirtualMachineImageList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "virtualmachinetemplates", &v1beta1.VirtualMachineTemplate{}, "VirtualMachineTemplate", &v1beta1.VirtualMachineTemplateList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "virtualmachinetemplateversions", &v1beta1.VirtualMachineTemplateVersion{}, "VirtualMachineTemplateVersion", &v1beta1.VirtualMachineTemplateVersionList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "keypairs", &v1beta1.KeyPair{}, "KeyPair", &v1beta1.KeyPairList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "upgrades", &v1beta1.Upgrade{}, "Upgrade", &v1beta1.UpgradeList{}, true, defaultActions)
	NewGenericResource(cloudweavv1beta1API, "supportbundles", &v1beta1.SupportBundle{}, "SupportBundle", &v1beta1.SupportBundleList{}, true, defaultActions)

	cloudweavNetworkv1beta1API := NewGroupVersionWebService(networkv1beta1.SchemeGroupVersion)
	NewGenericResource(cloudweavNetworkv1beta1API, "clusternetworks", &networkv1beta1.ClusterNetwork{}, "ClusterNetwork", &networkv1beta1.ClusterNetworkList{}, false, defaultActions)
	NewGenericResource(cloudweavNetworkv1beta1API, "nodenetworks", &networkv1beta1.NodeNetwork{}, "NodeNetwork", &networkv1beta1.NodeNetworkList{}, false, defaultActions)
	...
	return []*restful.WebService{cloudweavv1beta1API, cloudweavNetworkv1beta1API, corev1API, virtv1API, cniv1API}
}

func NewGroupVersionWebService(gv schema.GroupVersion) *restful.WebService {
	ws := new(restful.WebService)
	ws.Doc("The Cloudweav API.")
