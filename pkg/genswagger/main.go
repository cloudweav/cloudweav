...
import (
	...
	_ "github.com/cloudweav/cloudweav-network-controller/pkg/apis/network.cloudweavhci.io/v1beta1"

	"github.com/cloudweav/cloudweav/pkg/apis/cloudweavhci.io/v1beta1"
	"github.com/cloudweav/cloudweav/pkg/genswagger/rest"
)
...
// Generate OpenAPI spec definitions for Cloudweav Resource
func main() {
	flag.Parse()
...
func createConfig(webServices []*restful.WebService) *common.OpenAPIV3Config {
	return &common.OpenAPIV3Config{
		...
		GetDefinitionName: func(name string) (string, spec.Extensions) {
			//adapting k8s style
			name = strings.ReplaceAll(name, "github.com/cloudweav/cloudweav/pkg/apis/cloudweavhci.io", "cloudweavhci.io")
			name = strings.ReplaceAll(name, "github.com/cloudweav/cloudweav-network-controller/pkg/apis/network.cloudweavhci.io", "network.cloudweavhci.io")
