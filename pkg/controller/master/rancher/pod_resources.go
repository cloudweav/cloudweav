...
// Since multi-cluster-management-agent is disabled in the Cloudweav embedded Rancher,
// copy and modified this file from Rancher to fix https://github.com/cloudweav/cloudweav/issues/2310
