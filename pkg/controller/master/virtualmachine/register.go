...
import (
	...
	"github.com/cloudweav/cloudweav/pkg/util/resourcequota"
)
...
const (
	...
	// https://github.com/cloudweav/cloudweav/blob/78b0f20abb118b5d0fba564e18867b90a1d3c0ee/pkg/controller/master/virtualmachine/vm_controller.go#L97-L101
	deprecatedCloudweavUnsetOwnerOfPVCsFinalizer = "cloudweavhci.io/VMController.UnsetOwnerOfPVCs"
...
func Register(ctx context.Context, management *config.Management, _ config.Options) error {
	var (
		...
		rqCache        = management.CloudweavCoreFactory.Core().V1().ResourceQuota().Cache()
		...
		vmBackupClient = management.CloudweavFactory.Cloudweavhci().V1beta1().VirtualMachineBackup()
