...
const vmiListString = `
{
    ...
    "metadata": {
        "annotations": {
            "cloudweavhci.io/sshNames": "[\"default/gm\"]",
        ...
        "finalizers": [
            ...
            "wrangler.cattle.io/cloudweav-lb-vmi-controller"
        ],
        "generation": 12,
        "labels": {
            "cloudweavhci.io/vmName": "pinned-to-host",
            "kubevirt.io/nodeName": "cloudweav-kfs2c"
        },
        "name": "pinned-to-host",
        "namespace": "default",
        "ownerReferences": [
    ...
    "spec": {
                    ...
                    "nodeSelectorTerms": [
                        {
                            "matchExpressions": [
                                {
                                    "key": "network.cloudweavhci.io/mgmt",
                                    "operator": "In",
                                    "values": [
                                        "true"
                                    ]
        ...
        "nodeSelector": {
            "kubernetes.io/hostname": "cloudweav-kfs2c"
        },
    ...
    "status": {
        "activePods": {
            "59b3891b-7043-403a-8688-414942ae40fc": "cloudweav-kfs2c"
        },
        "conditions": [
            {
                "lastProbeTime": null,
...
func Test_virtualMachineContainsHostName(t *testing.T) {
	...
	node1 := &corev1.Node{
		ObjectMeta: metav1.ObjectMeta{
			Name: "cloudweav-kfs2c",
			Labels: map[string]string{
				"kubernetes.io/hostname":       "cloudweav-kfs2c",
				"network.cloudweavhci.io/mgmt": "true",
			},
		},
	...
	node2 := &corev1.Node{
		ObjectMeta: metav1.ObjectMeta{
			Name: "cloudweav-qhgd4",
			Labels: map[string]string{
				"kubernetes.io/hostname":       "cloudweav-qhgd4",
				"network.cloudweavhci.io/mgmt": "true",
			},
		},
		Status: corev1.NodeStatus{
	...
	node3 := &corev1.Node{
		ObjectMeta: metav1.ObjectMeta{
			Name: "cloudweav-rmvzg",
			Labels: map[string]string{
				"kubernetes.io/hostname":       "cloudweav-rmvzg",
				"network.cloudweavhci.io/mgmt": "true",
			},
		},
		Status: corev1.NodeStatus{
