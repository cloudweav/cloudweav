...
func (h *secretHandler) createHookJob(upgrade *cloudweavv1.Upgrade, nodeName string, jobType string, nextState string) error {
...
func checkEligibleToDrain(upgrade *cloudweavv1.Upgrade, nodeName string) error {
