...
const (
	backupBackingImageControllerName = "cloudweav-backup-backing-image-controller"
)
...
func (h *backupBackingImageHandler) OnBackupBackingImageChange(_ string, backupBackingImage *lhv1beta2.BackupBackingImage) (*lhv1beta2.BackupBackingImage, error) {
	...
	if shouldUpload {
		...
		cloudweavv1.MetadataReady.True(vmImageCopy)
		vmImageCopy.Status.BackupTarget = &cloudweavv1.BackupTarget{
