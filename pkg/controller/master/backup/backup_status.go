...
func (h *Handler) updateBackupProgress(volumeBackup *cloudweavv1.VolumeBackup) error {
...
func (h *Handler) updateConditions(vmBackup *cloudweavv1.VirtualMachineBackup) error {
	...
	for i := range vmBackupCpy.Status.VolumeBackups {
		...
		if vmBackupCpy.Spec.Type == cloudweavv1.Backup {
...
// of the correct Kind.
func (h *Handler) resolveVolSnapshotRef(namespace string, controllerRef *metav1.OwnerReference) *cloudweavv1.VirtualMachineBackup {
...
func getVolumeSnapshotContentName(volumeBackup cloudweavv1.VolumeBackup) string {
