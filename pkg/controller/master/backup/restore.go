...
const (
	restoreControllerName = "cloudweav-vm-restore-controller"

	volumeSnapshotKindName = "VolumeSnapshot"
	vmRestoreKindName      = "VirtualMachineRestore"

	restoreNameAnnotation  = "restore.cloudweavhci.io/name"
	lastRestoreAnnotation  = "restore.cloudweavhci.io/last-restore-uid"
	pvcNameSpaceAnnotation = "pvc.cloudweavhci.io/namespace"
	pvcNameAnnotation      = "pvc.cloudweavhci.io/name"
...
type RestoreHandler struct {
	...
	restores             ctlcloudweavv1.VirtualMachineRestoreClient
	restoreController    ctlcloudweavv1.VirtualMachineRestoreController
	restoreCache         ctlcloudweavv1.VirtualMachineRestoreCache
	backupCache          ctlcloudweavv1.VirtualMachineBackupCache
...
func RegisterRestore(ctx context.Context, management *config.Management, _ config.Options) error {
	restores := management.CloudweavFactory.Cloudweavhci().V1beta1().VirtualMachineRestore()
	backups := management.CloudweavFactory.Cloudweavhci().V1beta1().VirtualMachineBackup()
...
func (h *RestoreHandler) RestoreOnChanged(_ string, restore *cloudweavv1.VirtualMachineRestore) (*cloudweavv1.VirtualMachineRestore, error) {
...
func (h *RestoreHandler) RestoreOnRemove(_ string, restore *cloudweavv1.VirtualMachineRestore) (*cloudweavv1.VirtualMachineRestore, error) {
...
func (h *RestoreHandler) initStatus(restore *cloudweavv1.VirtualMachineRestore) error {
	restoreCpy := restore.DeepCopy()

	restoreCpy.Status = &cloudweavv1.VirtualMachineRestoreStatus{
...
func (h *RestoreHandler) initVolumesStatus(vmRestore *cloudweavv1.VirtualMachineRestore, backup *cloudweavv1.VirtualMachineBackup) error {
...
func (h *RestoreHandler) getVM(vmRestore *cloudweavv1.VirtualMachineRestore) (*kubevirtv1.VirtualMachine, error) {
...
func getVolumeRestores(vmRestore *cloudweavv1.VirtualMachineRestore, backup *cloudweavv1.VirtualMachineBackup) ([]cloudweavv1.VolumeRestore, error) {
	restores := make([]cloudweavv1.VolumeRestore, 0, len(backup.Status.VolumeBackups))
...
func (h *RestoreHandler) reconcileResources(
	vmRestore *cloudweavv1.VirtualMachineRestore,
	backup *cloudweavv1.VirtualMachineBackup,
...
func (h *RestoreHandler) getVMBackup(vmRestore *cloudweavv1.VirtualMachineRestore) (*cloudweavv1.VirtualMachineBackup, error) {
...
func (h *RestoreHandler) createNewVM(restore *cloudweavv1.VirtualMachineRestore, backup *cloudweavv1.VirtualMachineBackup) (*kubevirtv1.VirtualMachine, error) {
...
func (h *RestoreHandler) updateOwnerRefAndTargetUID(vmRestore *cloudweavv1.VirtualMachineRestore, vm *kubevirtv1.VirtualMachine) error {
	restoreCpy := vmRestore.DeepCopy()
...
func (h *RestoreHandler) createRestoredPVC(
	...
	volumeRestore cloudweavv1.VolumeRestore,
) error {
...
func (h *RestoreHandler) deleteOldPVC(vmRestore *cloudweavv1.VirtualMachineRestore, vm *kubevirtv1.VirtualMachine) error {
...
func (h *RestoreHandler) updateRestoreProgress(volumeRestore *cloudweavv1.VolumeRestore, isVolumesReady bool) error {
...
func (h *RestoreHandler) recifyProgressBeforeVMStart(vmRestore *cloudweavv1.VirtualMachineRestore) {
...
func (h *RestoreHandler) updateStatusError(restore *cloudweavv1.VirtualMachineRestore, err error, createEvent bool) error {
	restoreCpy := restore.DeepCopy()
