...
// Cloudweav VM backup & restore controllers helps to manage the VM backup & restore by leveraging
...
const (
	backupControllerName         = "cloudweav-vm-backup-controller"
	snapshotControllerName       = "volume-snapshot-controller"
	longhornBackupControllerName = "longhorn-backup-controller"
	pvcControllerName            = "cloudweav-pvc-controller"
	vmBackupKindName             = "VirtualMachineBackup"

	volumeSnapshotCreateEvent = "VolumeSnapshotCreated"

	backupTargetAnnotation       = "backup.cloudweavhci.io/backup-target"
	backupBucketNameAnnotation   = "backup.cloudweavhci.io/bucket-name"
	backupBucketRegionAnnotation = "backup.cloudweavhci.io/bucket-region"
...
type Handler struct {
	vmBackups                 ctlcloudweavv1.VirtualMachineBackupClient
...
func (h *Handler) OnBackupChange(_ string, vmBackup *cloudweavv1.VirtualMachineBackup) (*cloudweavv1.VirtualMachineBackup, error) {
...
func (h *Handler) OnBackupRemove(_ string, vmBackup *cloudweavv1.VirtualMachineBackup) (*cloudweavv1.VirtualMachineBackup, error) {
...
func (h *Handler) getBackupSource(vmBackup *cloudweavv1.VirtualMachineBackup) (*kubevirtv1.VirtualMachine, error) {
	var (
...
func (h *Handler) getBackupSourceInstance(vmBackup *cloudweavv1.VirtualMachineBackup) (*kubevirtv1.VirtualMachineInstance, error) {
...
func (h *Handler) tryFreezeFS(backup *cloudweavv1.VirtualMachineBackup) error {
...
func (h *Handler) withFreezeFSAnnotation(backup *cloudweavv1.VirtualMachineBackup) (*cloudweavv1.VirtualMachineBackup, error) {
...
func (h *Handler) saveFreezeFSAnnotation(backup *cloudweavv1.VirtualMachineBackup, value bool) (*cloudweavv1.VirtualMachineBackup, error) {
...
func (h *Handler) getVolumeBackups(backup *cloudweavv1.VirtualMachineBackup, vm *kubevirtv1.VirtualMachine) ([]cloudweavv1.VolumeBackup, error) {
	sourceVolumes := vm.Spec.Template.Spec.Volumes
	var volumeBackups = make([]cloudweavv1.VolumeBackup, 0, len(sourceVolumes))
	...
	for volumeName, pvcName := range volumeToPVCMappings(sourceVolumes) {
		...
		vb := cloudweavv1.VolumeBackup{
			Name:          &volumeBackupName,
			VolumeName:    volumeName,
			CSIDriverName: pv.Spec.PersistentVolumeSource.CSI.Driver,
			PersistentVolumeClaim: cloudweavv1.PersistentVolumeClaimSourceSpec{
...
func (h *Handler) getCSIDriverMap(backup *cloudweavv1.VirtualMachineBackup) (map[string]string, map[string]snapshotv1.VolumeSnapshotClass, error) {
...
func (h *Handler) getSecretBackups(vm *kubevirtv1.VirtualMachine) ([]cloudweavv1.SecretBackup, error) {
	...
	secretBackups := []cloudweavv1.SecretBackup{}
...
func (h *Handler) getSecretBackupFromSecret(namespace, name string) (*cloudweavv1.SecretBackup, error) {
	...
	// ref: https://github.com/cloudweav/cloudweav/issues/1536
	...
	return &cloudweavv1.SecretBackup{Name: secret.Name, Data: data}, nil
}

// initBackup initialize VM backup status and annotation
func (h *Handler) initBackup(backup *cloudweavv1.VirtualMachineBackup, vm *kubevirtv1.VirtualMachine) error {
	var err error
	backupCpy := backup.DeepCopy()
	backupCpy.Status = &cloudweavv1.VirtualMachineBackupStatus{
		ReadyToUse: pointer.BoolPtr(false),
		SourceUID:  &vm.UID,
		SourceSpec: &cloudweavv1.VirtualMachineSourceSpec{
			ObjectMeta: metav1.ObjectMeta{
	...
	if backup.Spec.Type == cloudweavv1.Backup {
		target, err := settings.DecodeBackupTarget(settings.BackupTargetSet.Get())
		if err != nil {
			return err
		}

		backupCpy.Status.BackupTarget = &cloudweavv1.BackupTarget{
...
func (h *Handler) reconcileVolumeSnapshots(vmBackup *cloudweavv1.VirtualMachineBackup, csiDriverVolumeSnapshotClassMap map[string]snapshotv1.VolumeSnapshotClass) error {
...
func (h *Handler) createVolumeSnapshot(vmBackup *cloudweavv1.VirtualMachineBackup, volumeBackup cloudweavv1.VolumeBackup, volumeSnapshotClass *snapshotv1.VolumeSnapshotClass) (*snapshotv1.VolumeSnapshot, error) {
	...
	snapshot := &snapshotv1.VolumeSnapshot{
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				{
					APIVersion: cloudweavv1.SchemeGroupVersion.String(),
...
func (h *Handler) createVolumeSnapshotContent(
	vmBackup *cloudweavv1.VirtualMachineBackup,
	volumeBackup cloudweavv1.VolumeBackup,
...
func (h *Handler) setStatusError(vmBackup *cloudweavv1.VirtualMachineBackup, err error) error {
	vmBackupCpy := vmBackup.DeepCopy()
	if vmBackupCpy.Status == nil {
		vmBackupCpy.Status = &cloudweavv1.VirtualMachineBackupStatus{}
	}

	vmBackupCpy.Status.Error = &cloudweavv1.Error{
		Time:    currentTime(),
...
func (h *Handler) deleteVMBackupMetadata(vmBackup *cloudweavv1.VirtualMachineBackup, target *settings.BackupTarget) error {
	var err error
	if target == nil {
...
func (h *Handler) uploadVMBackupMetadata(vmBackup *cloudweavv1.VirtualMachineBackup) error {
	...
	updateBackupCondition(vmBackupCopy, cloudweavv1.Condition{
		Type:               cloudweavv1.BackupConditionMetadataReady,
...
func sanitizeVolumeBackups(volumeBackups []cloudweavv1.VolumeBackup) []cloudweavv1.VolumeBackup {
...
func (h *Handler) forceDeleteVolumeSnapshotAndContent(namespace string, volumeBackups []cloudweavv1.VolumeBackup) error {
...
func (h *Handler) configureBackupTargetOnStatus(vmBackup *cloudweavv1.VirtualMachineBackup) (*cloudweavv1.VirtualMachineBackup, error) {
	...
	vmBackupCpy := vmBackup.DeepCopy()
	vmBackupCpy.Status.BackupTarget = &cloudweavv1.BackupTarget{
...
func (h *Handler) handleBackupReady(vmBackup *cloudweavv1.VirtualMachineBackup) error {
	...
	if vmBackup.Spec.Type == cloudweavv1.Snapshot {
		return nil
	}
...
func (h *Handler) configureCSIDriverVolumeSnapshotClassNames(vmBackup *cloudweavv1.VirtualMachineBackup) (*cloudweavv1.VirtualMachineBackup, error) {
