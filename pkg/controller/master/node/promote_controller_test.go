...
func (n *NodeBuilder) RoleMgmt() *NodeBuilder {
	n.node.Labels[CloudweavMgmtNodeLabelKey] = "true"
	return n
}

func (n *NodeBuilder) RoleWitness() *NodeBuilder {
	n.node.Labels[CloudweavWitnessNodeLabelKey] = "true"
	return n
}

func (n *NodeBuilder) RoleWorker() *NodeBuilder {
	n.node.Labels[CloudweavWorkerNodeLabelKey] = "true"
	return n
}

func (n *NodeBuilder) Cloudweav() *NodeBuilder {
	n.node.Labels[CloudweavManagedNodeLabelKey] = "true"
	return n
}
...
func (n *NodeBuilder) Running() *NodeBuilder {
	n.node.Annotations[CloudweavPromoteStatusAnnotationKey] = PromoteStatusRunning
	return n
}

func (n *NodeBuilder) Complete() *NodeBuilder {
	n.node.Annotations[CloudweavPromoteStatusAnnotationKey] = PromoteStatusComplete
	return n
}

func (n *NodeBuilder) Failed() *NodeBuilder {
	n.node.Annotations[CloudweavPromoteStatusAnnotationKey] = PromoteStatusFailed
	return n
}

func (n *NodeBuilder) Unknown() *NodeBuilder {
	n.node.Annotations[CloudweavPromoteStatusAnnotationKey] = PromoteStatusUnknown
	return n
}
...
var (
	...
	m1 = NewDefaultNodeBuilder().Name("m-1").Cloudweav().Management()
	m2 = NewDefaultNodeBuilder().Name("m-2").Cloudweav().Management()
	m3 = NewDefaultNodeBuilder().Name("m-3").Cloudweav().Management()

	witnc1 = NewDefaultNodeBuilder().Name("witness-c-1").Cloudweav().Complete().RoleWitness().Witness()
	witnr1 = NewDefaultNodeBuilder().Name("witness-r-1").Cloudweav().Running().Witness()
	witnf1 = NewDefaultNodeBuilder().Name("witness-f-1").Cloudweav().Failed().Witness()
	witnu1 = NewDefaultNodeBuilder().Name("witness-u-1").Cloudweav().Unknown().Witness()

	mc1 = NewDefaultNodeBuilder().Name("m-complete-1").Cloudweav().Complete().Management()

	wr1 = NewDefaultNodeBuilder().Name("w-running-1").Cloudweav().Running().Worker()
	wf1 = NewDefaultNodeBuilder().Name("w-failed-1").Cloudweav().Failed().Worker()

	wnr1 = NewDefaultNodeBuilder().Name("w-notready-1").Cloudweav().NotReady().Worker()
	wnr2 = NewDefaultNodeBuilder().Name("w-notready-2").Cloudweav().NotReady().Worker()

	wu1 = NewDefaultNodeBuilder().Name("w-unknown-1").Cloudweav().Unknown().Worker()

	wc1 = NewDefaultNodeBuilder().Name("w-complete-1").Cloudweav().Complete().Worker()

	w1 = NewDefaultNodeBuilder().Name("w-1").Cloudweav().Worker()
	w2 = NewDefaultNodeBuilder().Name("w-2").Cloudweav().Worker()
	w3 = NewDefaultNodeBuilder().Name("w-3").Cloudweav().Worker()

	w1rm  = NewDefaultNodeBuilder().Name("w-1-r-mgmt").Cloudweav().RoleMgmt().Worker()
	w1rwk = NewDefaultNodeBuilder().Name("w-1-r-worker").Cloudweav().RoleWorker().Worker()
	w1rw  = NewDefaultNodeBuilder().Name("w-1-r-witness").Cloudweav().RoleWitness().Worker()
	w2rw  = NewDefaultNodeBuilder().Name("w-2-r-witness").Cloudweav().RoleWitness().Worker()

	// zone aware nodes
	mu1z2 = NewDefaultNodeBuilder().Name("m-unmanaged-1-z2").Zone("zone2").Management()

	m1z1 = NewDefaultNodeBuilder().Name("m-1-z1").Zone("zone1").Cloudweav().Management()
	m2z2 = NewDefaultNodeBuilder().Name("m-2-z2").Zone("zone2").Cloudweav().Management()
	m3z3 = NewDefaultNodeBuilder().Name("m-3-z3").Zone("zone3").Cloudweav().Management()
	m4z1 = NewDefaultNodeBuilder().Name("m-4-z1").Zone("zone1").Cloudweav().Management()

	mc1z2 = NewDefaultNodeBuilder().Name("m-complete-1-z2").Zone("zone2").Cloudweav().Complete().Management()

	wr1z2 = NewDefaultNodeBuilder().Name("w-running-1-z2").Zone("zone2").Cloudweav().Running().Worker()
	wf1z2 = NewDefaultNodeBuilder().Name("w-failed-1-z2").Zone("zone2").Cloudweav().Failed().Worker()

	wnr1z2 = NewDefaultNodeBuilder().Name("w-notready-1-z2").Zone("zone2").Cloudweav().NotReady().Worker()
	wnr2z3 = NewDefaultNodeBuilder().Name("w-notready-2-z3").Zone("zone3").Cloudweav().NotReady().Worker()

	wu1z2 = NewDefaultNodeBuilder().Name("w-unknown-1-z2").Cloudweav().Unknown().Worker()

	wc1z2 = NewDefaultNodeBuilder().Name("w-complete-1-z2").Cloudweav().Complete().Worker()

	w1z1    = NewDefaultNodeBuilder().Name("w-1-z1").Zone("zone1").Cloudweav().Worker()
	w2z2    = NewDefaultNodeBuilder().Name("w-2-z2").Zone("zone2").Cloudweav().Worker()
	w3z3    = NewDefaultNodeBuilder().Name("w-3-z3").Zone("zone3").Cloudweav().Worker()
	w4z3    = NewDefaultNodeBuilder().Name("w-4-z3").Zone("zone3").Cloudweav().Worker()
	w5z2rm  = NewDefaultNodeBuilder().Name("w-5-z2-mgmt").Zone("zone2").Cloudweav().RoleMgmt().Worker()
	w6z2rwk = NewDefaultNodeBuilder().Name("w-6-z2-worker").Zone("zone2").Cloudweav().RoleWorker().Worker()
	w7z1    = NewDefaultNodeBuilder().Name("w-7-z1").Zone("zone1").Cloudweav().Worker()
)
