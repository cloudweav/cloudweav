...
// registerCluster imports Cloudweav to Rancher by applying manifests from the registration URL.
func (h *Handler) registerCluster(setting *cloudweavv1.Setting) error {
	url := setting.Value
	if url == "" {
