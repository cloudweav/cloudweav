...
func (h *Handler) syncAdditionalTrustedCAs(setting *cloudweavv1.Setting) error {
	...
	return h.redeployDeployment(h.namespace, "cloudweav")
}

func (h *Handler) syncAdditionalCASecrets(setting *cloudweavv1.Setting) error {
