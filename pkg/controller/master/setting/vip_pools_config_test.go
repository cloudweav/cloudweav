...
func TestSyncVipPoolsConfig(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		var handler = &Handler{
			settings:       fakeSettingClient(clientset.CloudweavhciV1beta1().Settings),
...
func (c fakeSettingClient) Create(setting *cloudweavv1.Setting) (*cloudweavv1.Setting, error) {
	return c().Create(context.TODO(), setting, metav1.CreateOptions{})
}

func (c fakeSettingClient) Update(setting *cloudweavv1.Setting) (*cloudweavv1.Setting, error) {
	return c().Update(context.TODO(), setting, metav1.UpdateOptions{})
}

func (c fakeSettingClient) UpdateStatus(setting *cloudweavv1.Setting) (*cloudweavv1.Setting, error) {
...
func (c fakeSettingClient) Get(name string, opts metav1.GetOptions) (*cloudweavv1.Setting, error) {
	return c().Get(context.TODO(), name, opts)
}

func (c fakeSettingClient) List(opts metav1.ListOptions) (*cloudweavv1.SettingList, error) {
...
func (c fakeSettingClient) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cloudweavv1.Setting, err error) {
	return c().Patch(context.TODO(), name, pt, data, metav1.PatchOptions{}, subresources...)
}

func (c fakeSettingClient) WithImpersonation(_ rest.ImpersonationConfig) (generic.NonNamespacedClientInterface[*cloudweavv1.Setting, *cloudweavv1.SettingList], error) {
	panic("implement me")
}
