...
func (h *Handler) syncAutoRotateRKE2Certs(setting *cloudweavv1.Setting) error {
...
func (h *Handler) rotateRKE2Certs(setting *cloudweavv1.Setting) (time.Duration, error) {
