...
import (
	...
	ctlnodecloudweav "github.com/cloudweav/node-manager/pkg/generated/controllers/node.cloudweavhci.io"
	...
	ctlcloudweavappsv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/apps"
	ctlharvbatchv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/batch"
	cluster "github.com/cloudweav/cloudweav/pkg/generated/controllers/cluster.x-k8s.io"
	ctlharvcorev1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/core"
	ctlcloudweavv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/cloudweavhci.io"
	cniv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/k8s.cni.cncf.io"
	"github.com/cloudweav/cloudweav/pkg/generated/controllers/kubevirt.io"
	loggingv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/logging.banzaicloud.io"
	longhornv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/longhorn.io"
	monitoringv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/monitoring.coreos.com"
	"github.com/cloudweav/cloudweav/pkg/generated/controllers/networking.k8s.io"
	snapshotv1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/snapshot.storage.k8s.io"
	ctlharvstoragev1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/storage.k8s.io"
	"github.com/cloudweav/cloudweav/pkg/generated/controllers/upgrade.cattle.io"
)
...
func SetupScaled(ctx context.Context, restConfig *rest.Config, opts *generic.FactoryOptions) (context.Context, *Scaled, error) {
	...
	cloudweavFactory, err := ctlcloudweavv1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, nil, err
	}
	scaled.CloudweavFactory = cloudweavFactory
	scaled.starters = append(scaled.starters, cloudweavFactory)

	cloudweavCoreFactory, err := ctlharvcorev1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, nil, err
	}
	scaled.CloudweavCoreFactory = cloudweavCoreFactory
	scaled.starters = append(scaled.starters, cloudweavCoreFactory)

	cloudweavBatchFactory, err := ctlharvbatchv1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, nil, err
	}
	scaled.CloudweavBatchFactory = cloudweavBatchFactory
	scaled.starters = append(scaled.starters, cloudweavBatchFactory)

	cloudweavStorageFactory, err := ctlharvstoragev1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, nil, err
	}
	scaled.CloudweavStorageFactory = cloudweavStorageFactory
	scaled.starters = append(scaled.starters, cloudweavStorageFactory)
...
func setupManagement(ctx context.Context, restConfig *rest.Config, opts *generic.FactoryOptions) (*Management, error) {
	...
	harv, err := ctlcloudweavv1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, err
	}
	management.CloudweavFactory = harv
	...
	management.CloudweavCoreFactory = harvCore
	...
	management.CloudweavBatchFactory = harvBatch
	...
	management.CloudweavStorageFactory = harvStorage
	...
	nodeconfig, err := ctlnodecloudweav.NewFactoryFromConfigWithOptions(restConfig, (*ctlnodecloudweav.FactoryOptions)(opts))
	if err != nil {
		return nil, err
	}
	...
	controllerRevision, err := ctlcloudweavappsv1.NewFactoryFromConfigWithOptions(restConfig, opts)
	if err != nil {
		return nil, err
	}
