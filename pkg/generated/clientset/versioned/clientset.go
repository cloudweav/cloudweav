...
type Interface interface {
	...
	CloudweavhciV1beta1() cloudweavhciv1beta1.CloudweavhciV1beta1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	cloudweavhciV1beta1 *cloudweavhciv1beta1.CloudweavhciV1beta1Client
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.cloudweavhciV1beta1, err = cloudweavhciv1beta1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.cloudweavhciV1beta1 = cloudweavhciv1beta1.New(c)
