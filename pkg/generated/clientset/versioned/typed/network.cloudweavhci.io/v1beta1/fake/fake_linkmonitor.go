...
func (c *FakeLinkMonitors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.LinkMonitor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(linkmonitorsResource, name), &v1beta1.LinkMonitor{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLinkMonitors) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.LinkMonitorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(linkmonitorsResource, linkmonitorsKind, opts), &v1beta1.LinkMonitorList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeLinkMonitors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(linkmonitorsResource, opts))
}
...
func (c *FakeLinkMonitors) Create(ctx context.Context, linkMonitor *v1beta1.LinkMonitor, opts v1.CreateOptions) (result *v1beta1.LinkMonitor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(linkmonitorsResource, linkMonitor), &v1beta1.LinkMonitor{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.LinkMonitor), err
...
func (c *FakeLinkMonitors) Update(ctx context.Context, linkMonitor *v1beta1.LinkMonitor, opts v1.UpdateOptions) (result *v1beta1.LinkMonitor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(linkmonitorsResource, linkMonitor), &v1beta1.LinkMonitor{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.LinkMonitor), err
...
func (c *FakeLinkMonitors) UpdateStatus(ctx context.Context, linkMonitor *v1beta1.LinkMonitor, opts v1.UpdateOptions) (*v1beta1.LinkMonitor, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(linkmonitorsResource, "status", linkMonitor), &v1beta1.LinkMonitor{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.LinkMonitor), err
...
func (c *FakeLinkMonitors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(linkmonitorsResource, listOpts)
...
func (c *FakeLinkMonitors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.LinkMonitor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(linkmonitorsResource, name, pt, data, subresources...), &v1beta1.LinkMonitor{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.LinkMonitor), err
