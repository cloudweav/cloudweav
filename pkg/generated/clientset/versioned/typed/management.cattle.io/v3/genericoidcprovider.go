...
func (c *genericOIDCProviders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.GenericOIDCProvider, err error) {
	result = &v3.GenericOIDCProvider{}
	err = c.client.Get().
		Resource("genericoidcproviders").
		Name(name).
...
func (c *genericOIDCProviders) List(ctx context.Context, opts v1.ListOptions) (result *v3.GenericOIDCProviderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v3.GenericOIDCProviderList{}
	err = c.client.Get().
		Resource("genericoidcproviders").
...
func (c *genericOIDCProviders) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *genericOIDCProviders) Create(ctx context.Context, genericOIDCProvider *v3.GenericOIDCProvider, opts v1.CreateOptions) (result *v3.GenericOIDCProvider, err error) {
	result = &v3.GenericOIDCProvider{}
	err = c.client.Post().
		Resource("genericoidcproviders").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(genericOIDCProvider).
		Do(ctx).
		Into(result)
	return
}
...
func (c *genericOIDCProviders) Update(ctx context.Context, genericOIDCProvider *v3.GenericOIDCProvider, opts v1.UpdateOptions) (result *v3.GenericOIDCProvider, err error) {
	result = &v3.GenericOIDCProvider{}
	err = c.client.Put().
		Resource("genericoidcproviders").
		Name(genericOIDCProvider.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(genericOIDCProvider).
		Do(ctx).
		Into(result)
...
func (c *genericOIDCProviders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *genericOIDCProviders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *genericOIDCProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.GenericOIDCProvider, err error) {
	result = &v3.GenericOIDCProvider{}
