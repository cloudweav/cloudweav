...
func (a *resourceQuotaStatusHandler) sync(key string, obj *v1beta1.ResourceQuota) (*v1beta1.ResourceQuota, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *resourceQuotaGeneratingHandler) Remove(key string, obj *v1beta1.ResourceQuota) (*v1beta1.ResourceQuota, error) {
	if obj != nil {
		return obj, nil
	}

	obj = &v1beta1.ResourceQuota{}
...
func (a *resourceQuotaGeneratingHandler) Handle(obj *v1beta1.ResourceQuota, status v1beta1.ResourceQuotaStatus) (v1beta1.ResourceQuotaStatus, error) {
...
func (a *resourceQuotaGeneratingHandler) isNewResourceVersion(obj *v1beta1.ResourceQuota) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *resourceQuotaGeneratingHandler) storeResourceVersion(obj *v1beta1.ResourceQuota) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
