...
const (
	...
	// Add to cloudweav-longhorn storageclass to protect it
	...
	CloudweavUpgradeImageRepository     = "panmeta/cloudweav-upgrade"
	...
	// kubevirt create a CRD object automatically: type kubevirt, name kubevirt, namespace: cloudweav-system
	...
	StorageClassCloudweavLonghorn = "cloudweav-longhorn" // the initial & default storageclass
	CloudweavChartReleaseName     = "cloudweav"          // the release name
