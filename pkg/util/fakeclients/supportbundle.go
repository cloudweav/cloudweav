...
func (c SupportBundleClient) UpdateStatus(_ *cloudweavv1.SupportBundle) (*cloudweavv1.SupportBundle, error) {
	panic("implement me")
}
...
func (c SupportBundleClient) OnChange(_ context.Context, _ string, _ generic.ObjectHandler[*cloudweavv1.SupportBundle]) {
	panic("implement me")
}

func (c SupportBundleClient) OnRemove(_ context.Context, _ string, _ generic.ObjectHandler[*cloudweavv1.SupportBundle]) {
	panic("implement me")
}

func (c SupportBundleClient) Cache() generic.CacheInterface[*cloudweavv1.SupportBundle] {
	panic("implement me")
}
...
func (c SupportBundleClient) WithImpersonation(_ rest.ImpersonationConfig) (generic.ClientInterface[*cloudweavv1.SupportBundle, *cloudweavv1.SupportBundleList], error) {
	panic("implement me")
}
...
func (c SupportBundleCache) AddIndexer(_ string, _ generic.Indexer[*cloudweavv1.SupportBundle]) {
	panic("implement me")
}
