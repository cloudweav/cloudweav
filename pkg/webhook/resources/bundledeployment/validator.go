...
func (v *bundleDeploymentValidator) Delete(_ *types.Request, oldObj runtime.Object) error {
	...
	if bundleDeployment != nil &&
		(bundleDeployment.Name == "mcc-cloudweav" || bundleDeployment.Name == "mcc-cloudweav-crd") {

		// Fleet cluster namespace and name is from:
		// https://github.com/cloudweav/cloudweav-installer/blob/f36c8cfaa68626c85cf4c35f681dd382880f2aa7/pkg/config/templates/rancherd-10-cloudweav.yaml#L76-L77
