...
import (
	...
	ctlcloudweavcorev1 "github.com/cloudweav/cloudweav/pkg/generated/controllers/core/v1"
...
func NewValidator(
	...
	pods ctlv1.PodCache,
	rqs ctlcloudweavcorev1.ResourceQuotaCache,
	vms ctlkubevirtv1.VirtualMachineCache,
	setting ctlcloudweavv1.SettingCache,
	vmBackup ctlcloudweavv1.VirtualMachineBackupCache,
	vmRestore ctlcloudweavv1.VirtualMachineRestoreCache,
	svmbackup ctlcloudweavv1.ScheduleVMBackupCache,
...
func (v *restoreValidator) handleNewVM(vmRestore *v1beta1.VirtualMachineRestore, vmBackup *v1beta1.VirtualMachineBackup) error {
	...
	// this can be removed after https://github.com/cloudweav/cloudweav/issues/4893
