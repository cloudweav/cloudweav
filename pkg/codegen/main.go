...
func main() {
	...
	controllergen.Run(args.Options{
		OutputPackage: "github.com/cloudweav/cloudweav/pkg/generated",
		Boilerplate:   "scripts/boilerplate.go.txt",
		Groups: map[string]args.Group{
			"cloudweavhci.io": {
				Types: []interface{}{
					cloudweavv1.KeyPair{},
					cloudweavv1.Preference{},
					cloudweavv1.Setting{},
					cloudweavv1.Upgrade{},
					cloudweavv1.UpgradeLog{},
					cloudweavv1.Version{},
					cloudweavv1.VirtualMachineBackup{},
					cloudweavv1.VirtualMachineRestore{},
					cloudweavv1.VirtualMachineImage{},
					cloudweavv1.VirtualMachineTemplate{},
					cloudweavv1.VirtualMachineTemplateVersion{},
					cloudweavv1.SupportBundle{},
					cloudweavv1.Addon{},
					cloudweavv1.ResourceQuota{},
					cloudweavv1.ScheduleVMBackup{},
				},
				GenerateTypes:   true,
