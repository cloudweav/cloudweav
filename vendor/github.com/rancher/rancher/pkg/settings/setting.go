...
var (
	...
	// UIDashboardCloudweavLegacyPlugin depending on ui-offline-preferred and if a Cloudweav Cluster does not contain it's own Cloudweav plugin, use this version of the plugin instead.
	UIDashboardCloudweavLegacyPlugin = NewSetting("ui-dashboard-cloudweav-legacy-plugin", "https://releases.rancher.com/cloudweav-ui/plugin/cloudweav-1.0.3-head/cloudweav-1.0.3-head.umd.min.js")
