...
type CloudProvider struct {
	...
	// CloudweavCloudProvider
	CloudweavCloudProvider *CloudweavCloudProvider `yaml:"cloudweavCloudProvider,omitempty" json:"cloudweavCloudProvider,omitempty"`
...
type CloudweavCloudProvider struct {
