...
func (in *CloudProvider) DeepCopyInto(out *CloudProvider) {
	*out = *in
	...
	if in.CloudweavCloudProvider != nil {
		in, out := &in.CloudweavCloudProvider, &out.CloudweavCloudProvider
		*out = new(CloudweavCloudProvider)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudweavCloudProvider) DeepCopyInto(out *CloudweavCloudProvider) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudweavCloudProvider.
func (in *CloudweavCloudProvider) DeepCopy() *CloudweavCloudProvider {
	if in == nil {
		return nil
	}
	out := new(CloudweavCloudProvider)
