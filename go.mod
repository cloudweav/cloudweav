module github.com/cloudweav/cloudweav

go 1.22.5

replace (
	github.com/containerd/containerd => github.com/containerd/containerd v1.6.27
...
require (
	...
	github.com/cloudweav/go-common v0.0.0-20240822134235-198df47889ca
	github.com/cloudweav/cloudweav-network-controller v0.3.1
	github.com/cloudweav/node-manager v0.3.1
...
require (
	...
	github.com/longhorn/go-spdk-helper v0.0.0-20240922062342-22115a91cbe9 // indirect
