...
In [installer PR 383](https://github.com/cloudweav/cloudweav-installer/pull/383) both of these parameters are introduced to /etc/cos/bootargs.cfg avoid situations where the harv-install script had a failure before the `update_grub_settings()` function and it didn't set the correct parameters.
</details>
